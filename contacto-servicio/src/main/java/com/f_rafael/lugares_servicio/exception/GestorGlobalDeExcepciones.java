...
public class GestorGlobalDeExcepciones {
    ...
    public ResponseEntity<ObjetoDeError> controlarCampoNuloException(CampoNuloException excepcion){
        ObjetoDeError objetoDeError = new ObjetoDeError();
    ...
    @ExceptionHandler(EnumeradoIncorrectoException.class)
    public ResponseEntity<ObjetoDeError> controlarEnumeradoIncorrectoException(EnumeradoIncorrectoException excepcion){
        ObjetoDeError objetoDeError = new ObjetoDeError();
