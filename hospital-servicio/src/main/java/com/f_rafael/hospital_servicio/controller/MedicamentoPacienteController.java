...
public class MedicamentoPacienteController {
    ...
    public ResponseEntity<List<MedicamentoPacienteDto>> buscarPorPrincipioActivo(@RequestParam("principio-activo") String principioActivo){
    ...
    @PatchMapping("/{id}/medicamento") // funciona
    ...
    @PatchMapping("/{id}/dosis") // funciona
